...
export default class AccountTooltip extends Account{
    ...
    render(){
        ...
        return [
            ...
            <Link to={this.state.address}><Avatar moniker={this.state.moniker} profileUrl={this.state.validator?this.state.validator.profile_url:''} address={this.state.address} list /> {this.state.moniker} </Link>
            </span>,
