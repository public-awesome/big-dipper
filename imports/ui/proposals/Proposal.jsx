    ...
    render() {
        if (this.props.loading) {
            ...
            if (this.props.proposalExist && this.state.proposal != '') {
                ...
                return <div>
                    <Helmet>
                        <title>{this.props.proposal.content.value.title} | Stakebird</title>
                                ...
                                <Table bordered responsive="sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> {this.props.proposal.content.value.changes ? this.props.proposal.content.value.changes.map((changesItem, i) => {
                                                return parseFloat(changesItem.value.replace(/"/g, "")) ? <div key={i}>{numbro(changesItem.value.replace(/"/g, "")).format("0,000")}</div> : <div key={i}>{changesItem.value.replace(/"|}|{/g, "")}</div>
                                            }) : ''}</td>
                                        </tr>
                                    </tbody>
                                </Table>
